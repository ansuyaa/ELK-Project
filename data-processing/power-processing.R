...
all_power = read.table("All_Blockgroup_Data_averaged_by_Month.csv", header=TRUE, na.strings = ".", sep=",")
all_consumption = read.table("Consumption_Blockgroup_Sharable_Detail_with_Temperatures.csv", header=TRUE, na.strings = ".", sep=",")
